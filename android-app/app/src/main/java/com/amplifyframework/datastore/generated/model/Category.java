...
public final class Category implements Model {
  ...
  private final @ModelField(targetType="BookCategory") @HasMany(associatedWith = "category", type = BookCategory.class) ModelList<BookCategory> books = null;
  ...
  public ModelList<BookCategory> getBooks() {
      return books;
  }
